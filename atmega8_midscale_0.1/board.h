...
#define BUT_LED_TEST_PIN6                          6
#define BUT_LED_TEST_PORT1                         channel1

#define ADC_LED_TEST_PIN2                          2
#define ADC_LED_TEST_PORT1                         channel1
...
#define BUT_LED_TEST(BUT_FLAG)            \
                                                 {\
                                                        if (BUT_FLAG)\
                                                        {\
                                                         SET_BIT(BUT_LED_TEST_PORT1,BUT_LED_TEST_PIN6);\
                                                        }\
                                                        else\
                                                        {\
                                                        CLEAR_BIT(BUT_LED_TEST_PORT1,BUT_LED_TEST_PIN6);\
                                                        }        \
                                                }
...
#define ADC_LED_TEST(ADC_FLAG)            \
                                                {\
                                                        if (ADC_FLAG)\
                                                        {\
                                                            SET_BIT(ADC_LED_TEST_PORT1,ADC_LED_TEST_PIN2);\
                                                        }\
                                                        else\
                                                        {\
                                                            CLEAR_BIT(ADC_LED_TEST_PORT1,ADC_LED_TEST_PIN2);\
                                                        }        \
                                                }
...
#define VOLT_DIV_MEASURE_CH1()                         (ADC_Read(VOLT_DIV_CH0))  *  (MCU_FACTOR) * (CORRECTION_X_CH0) * (ELEC_FACTOR_CH0)
